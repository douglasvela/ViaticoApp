...
$_SESSION['LAST_ACTIVITY'] = $time;
	...
	if(!$DAO->add($conexion,"insert into puesto (puesto) values ('$nombre')")){
...
$DAO->add($conexion,"insert into auditoria (au_usuario_sistema,tabla,PK,au_motivo,panel,au_ip) values ('$usuario','PUESTO','$nombre','AGREGAR PUETO','Nuevo puesto','$ip')");
            echo "EXITO";
