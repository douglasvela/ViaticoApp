...
$_SESSION['LAST_ACTIVITY'] = $time;
	...
	if(!$DAO->add($conexion,"Delete from comites where id_comite=$id")){
...
$DAO->add($conexion,"insert into auditoria (au_usuario_sistema,tabla,PK,au_motivo,panel,au_ip) values ('$usuario','COMITE','$id','ELIMINAR COMITE','Nuevo comite','$ip')");
            echo "EXITO";
	}
?>