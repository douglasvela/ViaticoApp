...
$_SESSION['LAST_ACTIVITY'] = $time;
	...
	if(!$DAO->add($conexion,"update puesto SET puesto='$nombre' where id=$id")){
...
$DAO->add($conexion,"insert into auditoria (au_usuario_sistema,tabla,PK,au_motivo,panel,au_ip) values ('$usuario','PUESTO','$id','MODIFICAR PUESTO','Nuevo puesto','$ip')");
            echo "EXITO";
	}
?>